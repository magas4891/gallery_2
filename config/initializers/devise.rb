...
Devise.setup do |config|
  ...
  config.mailer_sender =
    'please-change-me-at-config-initializers-users@example.com'
  ...
  # For bcrypt, this is the cost for hashing the password and
  #                                                        defaults to 11. If
  ...
  #                                                             performance of
  # your test suite dramatically. However, it is
  ...
  #                                                       their password is
  # reset. Defaults to true, so a user is signed in
  ...
  # When set to false, does not sign a user in automatically after
  #                                                           their password is
  # changed. Defaults to true, so a user is signed in automatically
